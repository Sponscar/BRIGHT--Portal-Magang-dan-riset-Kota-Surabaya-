...
let SertifikatController = class SertifikatController {
    ...
    generate(uid, d) { return this.svc.generate(uid, d); }
...
], SertifikatController.prototype, "generate", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SertifikatController.prototype, "findMine", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermission)(entities_1.PermissionLevel.VIEWER),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SertifikatController.prototype, "findById", null);
exports.SertifikatController = SertifikatController = __decorate([
    (0, common_1.Controller)('api/sertifikat'),
