...
async function seed() {
    ...
    for (const pt of data) {
        const exists = await em.findOne(entities_1.PerguruanTinggi, { nama: pt.nama });
        if (!exists) {
            const entity = new entities_1.PerguruanTinggi();
            entity.nama = pt.nama;
...
//# sourceMappingURL=perguruan-tinggi.seeder.js.map