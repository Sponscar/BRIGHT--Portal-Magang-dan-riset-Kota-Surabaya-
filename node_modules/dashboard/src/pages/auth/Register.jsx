...
const SearchableDropdown = ({ label, icon, placeholder, value, onSearchChange, showDropdown, onFocus, items, onSelect, manualOption, dropdownRef, required = true, readOnly = false }) => (
    <div className="space-y-1.5" ref={dropdownRef}>
        <label className="text-sm font-semibold text-[#1b140d]">{label}</label>
        <div className="relative group">
            ...
            <input
                className={`w-full pl-11 pr-10 py-3 border border-gray-200 rounded-xl text-sm text-[#1b140d] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all ${readOnly ? 'bg-green-50' : 'bg-gray-50'}`}
...
const InputField = ({ label, icon, id, placeholder, type = "text", value, onChange, required = true, readOnly = false, bgClass = "bg-gray-50" }) => (
    <div className="space-y-1.5">
        ...
        <div className="relative group">
            ...
            <input className={`w-full pl-11 pr-4 py-3 ${bgClass} border border-gray-200 rounded-xl text-sm text-[#1b140d] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all`}
                id={id} placeholder={placeholder} type={type} value={value} onChange={onChange} required={required} readOnly={readOnly} />
        </div>
    </div>
);
...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setError('');
        if (formData.password !== formData.confirmPassword) { setError('Password dan Konfirmasi Password tidak cocok'); return; }
        const phoneRegex = /^\d+$/;
        if (!phoneRegex.test(formData.phone)) { setError('Nomor Telepon harus berupa angka'); return; }
        if (formData.phone.length < 10) { setError('Nomor Telepon minimal 10 digit'); return; }
        if (formData.whatsapp && !phoneRegex.test(formData.whatsapp)) { setError('Nomor WhatsApp harus berupa angka'); return; }
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col lg:flex-row bg-white">
            ...
            >
                <div className="w-full max-w-[520px] bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden my-4">
                    {/* Tabs */}
                    ...
                    <div className="p-8 lg:p-10">
                        ...
                        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="w-full">
                                    <InputField label="No. Telp Aktif" icon="call" id="phone" type="tel" placeholder="08xxxxxxxxxx" value={formData.phone} onChange={handleChange} />
                                </div>
                                <div className="w-full">
                                    <InputField label="No. WhatsApp" icon="chat" id="whatsapp" type="tel" placeholder="08xxxxxxxxxx" value={formData.whatsapp} onChange={handleChange} required={false} />
                                </div>
                            </div>
                            ...
                            <SearchableDropdown
                                ...
                                onSearchChange={(e) => { setProvinsiSearch(e.target.value); setShowProvinsiDropdown(true); }}
                            ...
                            {isJawaTimur ? (
                                <SearchableDropdown
                                    ...
                                    value={kotaSearch}
                                    onSearchChange={(e) => { setKotaSearch(e.target.value); setShowKotaDropdown(true); }}
                                ...
                                <InputField label="Kota / Kabupaten" icon="location_city" id="kotaKabupaten" placeholder="Masukkan kota/kabupaten" value={formData.kotaKabupaten} onChange={handleChange} />
                            )}
                                ...
                                <div className="w-full">
                                    {isSurabaya ? (
                                        <SearchableDropdown
                                            ...
                                            onSearchChange={(e) => { setKecamatanSearch(e.target.value); setShowKecamatanDropdown(true); }}
                                        ...
                                        <InputField label="Kecamatan" icon="map" id="kecamatan" placeholder="Masukkan kecamatan" value={formData.kecamatan} onChange={handleChange} />
                                    )}
                                </div>
                                {/* Kelurahan */}
                                <div className="w-full">
                                    {isSurabaya && formData.kecamatan && kecamatanKelurahanSurabaya[formData.kecamatan] ? (
                                        <SearchableDropdown
                                            ...
                                            onSearchChange={(e) => { setKelurahanSearch(e.target.value); setShowKelurahanDropdown(true); }}
                                        ...
                                        <InputField label="Kelurahan" icon="pin_drop" id="kelurahan" placeholder="Masukkan kelurahan" value={formData.kelurahan} onChange={handleChange} />
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-[#1b140d] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none"
                                    id="alamatLengkap" placeholder="Nama Jalan, RT/RW, No. Rumah..." rows="3" value={formData.alamatLengkap} onChange={handleChange} required />
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="space-y-1.5 w-full">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input className="w-full pl-11 pr-11 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-[#1b140d] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                                            id="password" placeholder="••••••••" type={showPassword ? "text" : "password"} value={formData.password} onChange={handleChange} required />
                                ...
                                <div className="space-y-1.5 w-full">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input className="w-full pl-11 pr-11 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-[#1b140d] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                                            id="confirmPassword" placeholder="••••••••" type={showConfirmPassword ? "text" : "password"} value={formData.confirmPassword} onChange={handleChange} required />
                                        <button type="button" className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors cursor-pointer"
