...
let PresensiController = class PresensiController {
    ...
    checkIn(uid) { return this.svc.checkIn(uid); }
    submitPermission(uid, d, file) { return this.svc.submitPermission(uid, d, file); }
    findMine(uid) { return this.svc.findByUser(uid); }
    findAll(date) { return this.svc.findAll({ date }); }
    validate(id, status, uid) { return this.svc.validate(id, status, uid); }
};
...
], PresensiController.prototype, "checkIn", null);
__decorate([
    (0, common_1.Post)('permission'),
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermission)(entities_1.PermissionLevel.STUDENT),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('bukti')),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    ...
    __metadata("design:returntype", void 0)
], PresensiController.prototype, "submitPermission", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
    (0, permissions_decorator_1.RequirePermission)(entities_1.PermissionLevel.STUDENT),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PresensiController.prototype, "findMine", null);
__decorate([
    (0, common_1.Get)('all'),
    (0, common_1.UseGuards)(permissions_guard_1.PermissionsGuard),
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('statusValidasi')),
    __param(2, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], PresensiController.prototype, "validate", null);
exports.PresensiController = PresensiController = __decorate([
    (0, common_1.Controller)('api/presensi'),
